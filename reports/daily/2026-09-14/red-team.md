...
| Item | First verdict | After fix |
|---|---|---|
| `market-model.md` | flagged — SAM table unlabeled; $0.2–1.0M ARR inconsistent; ICI AUM unsourced on one line; NVIDIA “hand-build scenes” overclaim | pass — table labeled INFERENCE; ARR dropped; CTech URL on AUM; NVIDIA line softened |
| `ici-meeting-prep.md` | flagged — “SAM we will defend”; check-size vintage missing; “ICP spend is largely US” | pass — error-bar language; IIA 2020 + NFX; GTM wording |
| `brief.md` | flagged — $15–40M as fact; ICI figures unsourced | pass — inference + CTech/IIA/NFX links |
...
- Quote Mordor only as “robot software ~$6–8B, sim/digital-twin about a quarter of that,” then “we size a standalone eval wedge at $15–40M with wide error bars, and we win or lose on tens of high-fit teams.”
- Yaron’s real kill-shot is built-vs-slideware and Isaac — still UNKNOWN in memory. If Alon improvises a stack, the careful market memo will not save the meeting.
- Do not say minutes-as-SLA, a world-model vendor, sim-to-real %, or any logo “in talks.”
