...
- Proposed and created CRM: `memory/crm/investors/ici-fund.md` (Chief of Staff write)
- Working SAM 2026: **$15–40M** (base $25M) — **INFERENCE** (no census, no contracts) vs previous $91M 100%-attach
- TAM (dollar, FACT): robotic software platforms $6.07B (2025) / $7.58B (2026); sim/digital-twin slice ~$1.6B (Mordor 26.5%)
- Humanoid OEMs 45–53, not 60–80 “embodied AI”
...
- Syndicated “Physical AI” dollar figures ($4.50B vs $0.32B for 2025) disagree by ~14×. Mixing them with a 36.5% CAGR and a $91→$340–420M SAM is the core integrity risk tomorrow.
- Yaron will stress-test NVIDIA / in-house / open-source. A TAM slide that ignores those names is worse than a small SAM.
