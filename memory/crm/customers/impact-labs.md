...
- 2026-08-30 — Idan specified the task: hanging 3D-printed parts on a wire-mesh rack for AMT PostPro vapour smoothing (deformable wire/pin, CAD available, wants *relative* ranking of hang-hardware variants). Offered stand-in geometries; asked about IP/ownership boundaries.
- 2026-09-01 — Nitai acknowledged, said he would review technical questions with Alon, and waited for Idan's availability.
- 2026-09-07 — Nitai nudged for times.
- 2026-09-08 — Idan (Hebrew): holidays are busy; offered a Tel Aviv site visit with the project lead instead of a deep meeting.
- 2026-09-09 — Nitai offered to visit that day/next day, or reconnect after the holidays; used the word "פיילוט" in Hebrew — **not** a signed pilot.

**Not fact:** Impact Labs is not a customer or design partner. No visit confirmed. No NDA. No scope locked.
